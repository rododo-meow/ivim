...
if has("user_commands")
  ...
  let vundle_readme=expand('~/ivim/bundle/Vundle.vim/README.md')
  if !filereadable(vundle_readme)
    echo "Installing Vundle.."
    echo ""
    silent !mkdir -p ~/ivim/bundle
    silent !git clone https://github.com/VundleVim/Vundle.vim.git ~/ivim/bundle/Vundle.vim
